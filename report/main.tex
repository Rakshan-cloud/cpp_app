...
The library is available at: \url{https://github.com/Rakshan-cloud/cpp\_app} within the \texttt{qr\_ticket\_manager/} directory, installable via \texttt{pip install -e .} from the package root.
