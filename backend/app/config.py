...
class Config:
    ...
    CORS_ORIGINS = os.environ.get("CORS_ORIGINS", "http://localhost:3000,http://rakshan-frontend.s3-website-eu-west-1.amazonaws.com").split(",")
    COGNITO_USER_POOL_ID = os.environ.get("COGNITO_USER_POOL_ID", "eu-west-1_yK2wHJqUR")
